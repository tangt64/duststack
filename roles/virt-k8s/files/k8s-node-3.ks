...
firewall --disabled
# Network information
network  --bootproto=static --device=eth1 --ip=192.168.90.150 --netmask=255.255.255.0
network  --bootproto=static --device=eth0 --gateway=192.168.122.1 --ip=192.168.122.150 --nameserver=8.8.8.8 --netmask=255.255.255.0 --hostname=node-3.example.com
...
%post
hostnamectl set-hostname node-3.example.com
